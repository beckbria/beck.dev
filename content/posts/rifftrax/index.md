...
![The silence button in the Audacity user interface](audacity-silence.png)
...
![The Add Source Files button in the MKVToolNix user interface](mkvtoolnix-addsource.png)
...
![Editing an audio track in the MKVToolNix user interface](mkvtoolnix-edittrack.png)

Provide a name for the merged file and click "Start multiplexing".

![Naming the output file in the MKVToolNix user interface](mkvtoolnix-multiplex.png)
